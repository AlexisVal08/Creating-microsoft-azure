...
## 1. **Go to website to begin a brand new Microsoft Azure account:**
   ...
   - Create new account with your email and put in the verfication code sent to your Email.
   - Fill in all your pesronal inforamtion, then your account will be ready for you.
...
## 2. **Within the Azure Portal, Create a Resource Group:**
   ...
   - The resource group is essentially a folder dedictated to whatever you decide to use it for. 
...
## 3. **Create a Storage Account within the Resource Group created in Step 2:**
   ...
   - Wait for the everything to go green with verification passed and click `create`. This may take a while so be patient (up to 30 minutes).
   ...
   - Search for your storage account, type storage accounts and click back to storage account.
   - Your storage account should appear like this with the name -> resource group -> subscription intacted correctly.
...
## 9. **Check on cost management and billing:**
   ...
   - You are responsible for your azure account!
   - Type and click `cost management + billing`
   - Once on the webpage click on your account in the case `josh madakor`.
   - Click the section `azure subscriptions`.
...
7. RESPONSIBLE AND APPROPRIATELY CHECK YOUR ACCOUNT CURRENT USAGE COST AND PROJECTED COST.
